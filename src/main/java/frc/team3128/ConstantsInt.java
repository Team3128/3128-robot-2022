...
public class ConstantsInt extends Constants {
    ...
    public static class HoodConstants extends Constants.HoodConstants {
        ...
        public static final double SET_ANGLE = 22.75;
    ...
    static {
        ...
        categories.put("HoodConstants", ConstantsInt.HoodConstants.class);
